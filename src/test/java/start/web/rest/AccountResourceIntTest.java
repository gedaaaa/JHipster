...
import start.domain.Authority;
import start.domain.PersistentToken;
import start.domain.User;
import start.repository.AuthorityRepository;
import start.repository.PersistentTokenRepository;
...
import start.web.rest.vm.KeyAndPasswordVM;
import start.web.rest.vm.ManagedUserVM;
